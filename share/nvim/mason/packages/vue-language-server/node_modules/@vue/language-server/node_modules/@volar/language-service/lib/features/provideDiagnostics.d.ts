...
export declare function transformDiagnostic(context: LanguageServiceContext, error: vscode.Diagnostic, map: SourceMapWithDocuments | undefined, filter: (data: CodeInformation) => boolean): vscode.Diagnostic | undefined;
